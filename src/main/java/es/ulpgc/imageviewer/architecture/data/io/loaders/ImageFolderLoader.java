package es.ulpgc.imageviewer.architecture.data.io.loaders;
...
public class ImageFolderLoader implements ImageLoader {
    ...
    public ImageFolderLoader(File folder) throws IOException, EmptyImageFolderException {
